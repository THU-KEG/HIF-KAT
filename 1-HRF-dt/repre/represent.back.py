...
from .graphconv import GraphConvLayer, GraphAtteLayer
...
class RepresentationModel(nn.Module):
    def __init__(
        ...
        embedding_weights,
        embedding_trainable,
        # node_id,    # Should be Python List() Type
        # prod_id,    # Should be Python List() Type
        adj_ind,    # Should be PyTorch Long Type Tensor
        adj_wei,    # Should be PyTorch Float Type Tensor
        vocab_size,
        ...
        add_bias = True,
        lstm_summarizer_bidirectional = True,
        gcn_residual = False,
        gcn_drop_rate = 0.4,
        lstm_drop_rate = 0.4,
        mask_drop_rate = 0.2,
        ...
        self.gcn1 = GraphConvLayer(
            ...
            input_dim = cur_dim,
            output_dim = next_dim,
            dropout = gcn_drop_rate,
            activation = activation,
            device = device,
            text_field = training_fields + [title_field, ],
            share = graphconv_para_share,
            bias = add_bias,
            residual = False
        )
